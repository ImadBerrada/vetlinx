...
export type OutboxEventWhereInput = {
  ...
  name?: Prisma.StringFilter<"OutboxEvent"> | string
  version?: Prisma.IntFilter<"OutboxEvent"> | number
...
export type OutboxEventScalarWhereWithAggregatesInput = {
  ...
  name?: Prisma.StringWithAggregatesFilter<"OutboxEvent"> | string
  version?: Prisma.IntWithAggregatesFilter<"OutboxEvent"> | number
...
export type OutboxEventOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"id" | "name" | "version" | "aggregateId" | "correlationId" | "causationId" | "payload" | "occurredAt" | "status" | "attempts" | "publishedAt" | "lastError" | "createdAt", ExtArgs["result"]["outboxEvent"]>
...
export interface OutboxEventFieldRefs {
  ...
  readonly name: Prisma.FieldRef<"OutboxEvent", 'String'>
  readonly version: Prisma.FieldRef<"OutboxEvent", 'Int'>
